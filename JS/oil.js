...
# 脚本作者: yfamily
# 更新时间: 2024-08-12
# 仓库地址: https://raw.githubusercontent.com/deezertidal/private/main/oil.js
...
if (typeof $argument !== "undefined") {
  ...
  provname = "浙江";//quantumultx用户请复制到本地脚本 更改其他省 省份名不能含"省"字。小火箭loon用户请看模块插件注释 surge请用面板
}
//默认浙江油价
const encodedprovname = 
encodeURIComponent(provname);
const apiUrls = [
